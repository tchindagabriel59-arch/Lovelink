...
// ═══════════════════════════════════════
// POST : Envoyer un nouveau message (SANS LIMITATION DE PAYWALL)
// ═══════════════════════════════════════
export async function POST(
  ...
  try {
    ...
    // 1. Récupérer le match et les infos de l'expéditeur
    ...
    // 2. 🛡️ SÉCURITÉ : VÉRIFICATION D'ÉCHANGE DE CONTACTS AVANT 30 MESSAGES
