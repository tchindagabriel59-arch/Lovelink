...
type FilterType = "all" | "new" | "online" | "conversations";
    ...
    <div className="group relative bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
      ...
      <div className={`aspect-[3/4] bg-gradient-to-br ${gradient} relative overflow-hidden`}>
        ...
        {match.user.isPremium && (
          <div className="absolute top-3 right-12 w-7 h-7 bg-gradient-to-br from-amber-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg">
      ...
      <div className="p-3">
        ...
        <Link
          ...
          className="w-full flex items-center justify-center gap-1.5 py-2 bg-gradient-to-r from-rose-500 to-purple-600 hover:shadow-lg text-white rounded-lg text-sm font-semibold transition"
        >
